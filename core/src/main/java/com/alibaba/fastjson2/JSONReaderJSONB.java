...
class JSONReaderJSONB
    ...
    public final long readInt64Value() {
        ...
        if (type >= BC_INT64_NUM_MIN && type <= BC_INT64_NUM_MAX) {
            ...
            this.offset = offset;
            return readInt64ValueTypeNotMatch(bytes, type);
        }
        this.offset = offset;
        return int64Value;
    }
    ...
    public final int readInt32Value() {
        ...
        if (type >= BC_INT32_NUM_MIN && type <= BC_INT32_NUM_MAX) {
            ...
            this.offset = offset;
            return readInt32ValueNotMatchType(bytes, type);
        }
        this.offset = offset;
        return int32Value;
    }
        ...
        switch (type) {
            ...
            case BC_DECIMAL: {
                ...
                if (bytes[offset] == BC_INT32) {
                    offset++;
                    int unscaledValue = getInt(bytes, offset);
                    offset += 4;
        ...
        switch (type) {
            ...
            case BC_STR_UTF16LE: {
                ...
                Charset charset = type == BC_STR_UTF16BE
                        ? IOUtils.UTF_16BE
                        : type == BC_STR_UTF16LE ? IOUtils.UTF_16LE : IOUtils.UTF_16;
