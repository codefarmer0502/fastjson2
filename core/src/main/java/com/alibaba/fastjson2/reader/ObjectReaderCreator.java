            ...
            if (fieldTypeResolved instanceof ParameterizedType) {
                ...
                if (actualTypeArguments.length == 1) {
                    ...
                    if (itemClass == String.class) {
                        ...
                        return new FieldReaderList(fieldName, fieldTypeResolved, fieldClassResolved, String.class, String.class, ordinal, features, format, locale, null, null, field, null);
                    }
                    ...
                    return new FieldReaderList(fieldName, fieldTypeResolved, fieldClassResolved, itemType, itemClass, ordinal, features, format, locale, defaultValue, null, field, null);
                }
            }
